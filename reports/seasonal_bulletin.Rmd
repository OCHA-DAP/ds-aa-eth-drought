...
DATASET <- "seas5" # or "era5" supported

SEVERITY <- "tercile" # quartile or tercile 
YEAR <- 2025 # also need to change some plot titles
...
gdf_pin <- get_eth_gdf_pin(YEAR) # This contains all adms in ETH
...
df_summary <- join_pin_rainfall(gdf_pin, df_rainfall_processed)
...
ggplot(df_annual_summary, aes(x = total_rainfall, y = total_pin)) +
  ...
  labs(
    title = glue("Annual {SEASON} total rainfall vs est. PiN impacted by drought"),
    x = "Total Rainfall (mm)",
